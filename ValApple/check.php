...
$scnt = getStr(curl("https://idmsac.apple.com/IDMSWebAuth/login.html?appIdKey=3b356c1bac5ad9735ad62f24d43414eb59715cc4d21b178835626ce0d2daa77d&rv=5&path=/jibe"), "scnt\" name=\"scnt\" value=\"", "\"");
...
$rollingCurl->setCallback(function(\RollingCurl\Request $request, \RollingCurl\RollingCurl $rollingCurl) use (&$results) {
	...
	echo " [".date("H:i:s")." ".$no."/".$total." from ".$listname." to ".$dir."] ";
